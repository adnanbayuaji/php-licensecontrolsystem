                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Add Update License</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Form</strong> Update License
                                </div>
                                <div class="card-body card-block">
                                    <form method="post" action="proses_lisen_upd.php" enctype="multipart/form-data" class="form-horizontal">
                                    <input type="hidden" name="id" value="<?php echo $id; ?>" readonly="value">
                                    <input type="text" name="stat" value="Closed" readonly="value" hidden>
                                    <input type="text" name="ket_new" value="Not Used" readonly="value" hidden>
                                    <input type="date" name="tgl_close" value="<?php $tgl=date('Y-m-d'); echo $tgl; ?>" readonly="value" hidden>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="no_lcns" name="no_lcns" placeholder="masukkan nomor lisensi baru" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label class=" form-control-label">Lisensi Lama</label></div>
                                            <div class="col-12 col-md-9">
                                                    <select name="no_lcns_old" id="no_lcns_old" class="form-control" required>
                                                        <option value="">- Pilih Lisensi Lama -</option>
                                                        <?php 
                                                            $result = mysql_query("SELECT * FROM lcs_lisensi WHERE tgl_war <= now()");      
                                                            while ($row = mysql_fetch_array($result)) {    
                                                                echo '<option value="' . $row['no_lcns'] . '">'.$row['plan'].' | '.$row['no_lcns'].' | '.$row['ket_lcns'].' | '. $row['nm_srtfkt'] .'</option>';   
                                                            }      
                                                        ?>
                                                    </select>
                                            </div>
                                        ...
                                        <input type="text" id="ket_new" name="ket_lcns2" value="Not Used" class="form-control" readonly hidden>
