                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
													$query = mysql_query ("select * from lcs_lisensi WHERE exprd_lcns <= CURDATE() and plan='".$_GET['p']."';", $con);
													// cek total row
													...
													if ( $total_row > 0 ) {
														...
														$no = 1;
														$exp2 = date("Y-m-d");
														$lihat = mysql_query("select * from lcs_lisensi where exprd_lcns <= CURDATE() and plan='".$_GET['p']."'");
								...
								<a href="dwnld_exp.php?p=<?php echo $_GET['p']; ?>"><button type="button" class="btn btn-success"><i class="fa fa-windows"></i>&nbsp; Download to Excel</button></a>
                            </div>
                        </div>
                    </div>
                </div>
