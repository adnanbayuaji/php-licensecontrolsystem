...
session_start();
if ( !empty( $_POST ) ) {
	$query = mysql_query ("INSERT INTO lisensi (plan, jns_srtfkt, no_lcns, ket_lcns, nm_srtfkt, pnrbt_srtfkt, tgl_lcns, exprd_lcns, tgl_war, stat)
							VALUES(
							'{$_POST['plan']}',
							'{$_POST['jns_srtfkt']}',
							'{$_POST['no_lcns']}',
	...
	if(!$query) {
		echo "INSERT INTO lisensi (plan, jns_srtfkt, no_lcns, ket_lcns, nm_srtfkt, pnrbt_srtfkt, tgl_lcns, exprd_lcns, tgl_war, stat)
								  VALUES(
									'{$_POST['plan']}',
									'{$_POST['jns_srtfkt']}',
									'{$_POST['no_lcns']}',
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-plus-square"></i><a href="form_lisen.php">Tambah License</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Form</strong> Add License
                            </div>
                                ...
                                <input type="date" name="tgl_close" value="<?php $tgl=date('Y-m-d'); echo $tgl; ?>" readonly="value" hidden>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="plan" name="plan" placeholder="Section Akan Terisi Otomatis" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="row form-group">
		...
		<div class="breadcrumbs" style="padding: 10px;">
			<footer id="header" class="header">
				...
				<div class="header-menu">
					...
					<center>
						&copy;2018. All Right Reserved | Aan Kurniawan - GA Operation 3
					</center>
