                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Lisensi Closed</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" style="background: red; color: white;">
                                <strong class="card-title">List Lisensi Closed</strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php
													...
													if ( $total_row > 0 ) {
														...
														$no = 1;
														$exp2 = date("Y-m-d");
														$lihat = mysql_query("select * from lcs_lisensi WHERE stat LIKE 'Closed'");
														while ( $row = mysql_fetch_array($lihat) ) {
															...
															echo '<td>'.TanggalIndo2($row['tgl_close']).'</td>';
															echo '<td>'.$row['stat'].'</td>';
															echo '<td align=center valign=center>';															
															echo '<a href="prev_lisen.php?id='.$row['id'].'"class="text-secondary"><i class="fa fa-file-o"></i></a>  &nbsp; &nbsp;|&nbsp; &nbsp; ';
								...
								<a href="dwnld_c.php"><button type="button" class="btn btn-success"><i class="fa fa-windows"></i>&nbsp; Download to Excel</button></a>
                            </div>
                        </div>
                    </div>
                </div>
