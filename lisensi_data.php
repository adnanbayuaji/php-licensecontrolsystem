                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if ( $total_row > 0 ) {
                                                ...
                                                $no = 1;
                                                $exp2 = date("Y-m-d");
                                                $lihat = mysql_query("select * from lcs_lisensi");
                                                ...
                                                echo '<tr align=center><td colspan="10"><h5>Belum Ada Licenses</h5></td></tr>';
                                            }
										?>
                                    </tbody>
                                </table>
								<a href="dwnld_a.php"><button type="button" class="btn btn-success"><i class="fa fa-windows"></i>&nbsp; Download to Excel</button></a>
                            </div>
                        </div>
                    </div>
                </div>
