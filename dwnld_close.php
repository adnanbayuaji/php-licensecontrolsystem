                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" border=1 cellspacing=0 cellpadding=0>
                                    <thead>
                                        <tr>
											...
											<th bgcolor="#99CCFF">Tanggal Closed</th>
											<th bgcolor="#99CCFF">Status</th>
											<th bgcolor="#99CCFF">No. Lisensi Baru</th>
											<th bgcolor="#99CCFF">Keterangan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
													$query = mysql_query ("select * from lcs_lisensi WHERE stat LIKE 'Closed'", $con);
													// cek total row
													...
													if ( $total_row > 0 ) {
														...
														while ( $row = mysql_fetch_array($lihat) ) {
															...
															echo '<td bgcolor=red><font color=white>'.$row['stat'].'</font></td>';
